                ...
                <div class="text-center heading ltr:lg:text-left rtl:lg:text-right">
                            ...
                            <a href="javascript:" class="group">
                                <svg width="100%" height="100%" viewBox="0 0 66 66" fill="none"
                                    ...
                                    <g opacity="0.3" class="transition duration-500 group-hover:opacity-100">
                                        <circle cx="32.782" cy="32.782" r="31.5" transform="rotate(-0.49927 32.782 32.782)"
                                            stroke="#1778F2" stroke-width="2" />
                                    </g>
                                    <path
                        ...
                        <li class="h-[45px] w-[45px] md:h-[60px] md:w-[60px]">
                            <a href="{{  __('contact.instagram')}}" class="group">
                                <svg width="100%" height="100%" viewBox="0 0 66 66" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.3" class="transition duration-500 group-hover:opacity-100">
                                        <mask id="mask0_553_5772" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0"
                                            y="0" width="66" height="66">
                        ...
                        {{-- <li class="h-[45px] w-[45px] md:h-[60px] md:w-[60px]">
                            <a href="javascript:" class="group">
                                <svg width="100%" height="100%" viewBox="0 0 66 66" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.3" class="transition duration-500 group-hover:opacity-100">
                                        <circle cx="33.3459" cy="32.782" r="31.5"
                                            transform="rotate(-0.49927 33.3459 32.782)" stroke="#1DA1F2" stroke-width="2" />
                                    </g>
                                    <path
                        ...
                        <li class="h-[45px] w-[45px] md:h-[60px] md:w-[60px]">
                            <a href="javascript:" class="group">
                                <svg width="100%" height="100%" viewBox="0 0 66 66" fill="none"
                                    ...
                                    <g opacity="0.3" class="transition duration-500 group-hover:opacity-100">
                                        <circle cx="33.3459" cy="32.782" r="31.5"
                                            transform="rotate(-0.49927 33.3459 32.782)" stroke="#E74D89" stroke-width="2" />
                                    </g>
                    ...
                    <div class="text-xl text-left text-black dark:text-white">
                        ...
                        <div class="flex justify-center py-3 lg:justify-start">
                            ...
                            <a href="tel:+62 87884433420" class="pl-3 -pt-2">{{ __('contact.telpon')}} ({{
                                __('contact.pemilik_telpon')}})</a>
                        </div>
                    </div>
                </div>
