...
<div>
    ...
    <section class="bg-gradient-to-t from-white/[55%] to-transparent py-14 dark:bg-black lg:py-[100px]">
        ...
        <div class="container">
            <div class="overflow-x-auto">
                <ul
                    ...
                    {{-- <li class="filter" data-filter="australia">
                        <button type="button" class="rounded-[10px] py-4 px-5 leading-5 transition text-white capitalize bg-black btn dark:bg-white dark:text-black hover:bg-black">
                            Australia
                        </button>
                    </li> --}}
            ...
            <div class="grid gap-8 mt-10 projects sm:grid-cols-2 lg:grid-cols-3">
                {{-- <div class="project" data-filter="australia">
                    ...
                    >
                        <a href="{{ url('/australia') }}" class="absolute top-0 w-full h-full ltr:left-0 rtl:right-0"></a>
                <img src="{{ url('/storage/images/ausie/keong.jpg') }}" alt="project-1"
                    class="object-cover w-full h-52 rounded-t-3xl" />
                <div class="p-5 text-sm font-bold">
                    <h6 class="mb-1 text-black dark:text-white">Gedung Opera</h6>
                    <p>Australia</p>
                </div>
            </div>
        </div> --}}
        <div class="project" data-filter="malaysia">
            <div
                class="relative rounded-3xl border border-transparent bg-white drop-shadow-[5px_10px_80px_rgba(119,128,161,0.15)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark dark:drop-shadow-none">
                <a href="{{ url('/storage/pdf/malaysia.pdf') }}"
                    class="absolute top-0 w-full h-full ltr:left-0 rtl:right-0"></a>
                <img src="{{ url('/storage/pdf/brosur-malaysia.png') }}" alt="project-1"
                    class="object-cover w-full h-52 rounded-t-3xl" />
                <div class="p-5 text-sm font-bold">
                    <h6 class="mb-1 text-black dark:text-white">Brosur</h6>
                    <p>Malaysia 1</p>
                </div>
            </div>
        </div>
        <div class="project" data-filter="malaysia">
            <div
                class="relative rounded-3xl border border-transparent bg-white drop-shadow-[5px_10px_80px_rgba(119,128,161,0.15)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark dark:drop-shadow-none">
                <a href="{{ url('/storage/pdf/malaysia2.pdf') }}"
                    class="absolute top-0 w-full h-full ltr:left-0 rtl:right-0"></a>
                <img src="{{ url('/storage/pdf/brosur-malaysia-2.png') }}" alt="project-1"
                    class="object-cover w-full h-52 rounded-t-3xl" />
                <div class="p-5 text-sm font-bold">
                    <h6 class="mb-1 text-black dark:text-white">Brosur</h6>
                    <p>Malaysia 2</p>
        ...
        <div class="project" data-filter="canada">
            <div
                class="relative rounded-3xl border border-transparent bg-white drop-shadow-[5px_10px_80px_rgba(119,128,161,0.15)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark dark:drop-shadow-none">
                <a href="{{ url('/storage/pdf/canada.pdf') }}"
                    class="absolute top-0 w-full h-full ltr:left-0 rtl:right-0"></a>
                <img src="{{ url('/storage/pdf/brosur-canada.png') }}" alt="project-1"
                    class="object-cover w-full h-52 rounded-t-3xl" />
                <div class="p-5 text-sm font-bold">
                    <h6 class="mb-1 text-black dark:text-white">Brosur</h6>
                    <p>Canada</p>
