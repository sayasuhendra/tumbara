    ...
    <div class="container">
        <div class="items-center py-10 md:flex md:h-[400px] md:py-0">
            <div class="heading relative mb-0 md:w-[725px]">
                ...
                <p
                    class="relative mt-7 mb-20 font-medium text-[#BBC0D0] before:absolute before:top-0 before:h-full before:w-1 before:bg-primary ltr:pl-8 ltr:before:left-0 rtl:pr-8 rtl:before:right-0">
                    {{  __('contact.description.1') }}
                    <br>
                    {{  __('contact.description.2') }}
                    <br>
                    {{  __('contact.description.3') }}
                </p>
            </div>
        </div>
    ...
    <section class="bg-gradient-to-t from-white/[55%] to-transparent py-14 dark:bg-black lg:py-[100px]">
        <div class="container">
            <div class="relative z-10 lg:flex">
                <div class="text-center heading ltr:lg:text-left rtl:lg:text-right">
                    <h4 class="sm:!leading-[50px]">
                        {{  __('contact.intouch') }}
                    </h4>
                    <ul class="flex items-center justify-center gap-4 mt-8 lg:justify-start" data-aos="fade-up"
                        ...
                        <li class="h-[45px] w-[45px] md:h-[60px] md:w-[60px]">
                            <a href="{{  __('contact.instagram')}}" class="group">
                                <svg width="100%" height="100%" viewBox="0 0 66 66" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.3" class="transition duration-500 group-hover:opacity-100">
                                        <mask id="mask0_553_5772" style="mask-type: alpha" maskUnits="userSpaceOnUse"
                                            x="0" y="0" width="66" height="66">
                                            <circle cx="32.782" cy="32.782" r="31.5"
                                                transform="rotate(-0.49927 32.782 32.782)" stroke="#1778F2"
                                                stroke-width="2" />
                                        </mask>
                    ...
                    <div class="text-xl text-left text-black dark:text-white">
                        <br>
                        <div class="flex justify-center py-3 lg:justify-start">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                            </svg>
                            <a href="mailto:{{  __('contact.email_address')}}" class="pl-3 -pt-2">
                        ...
                        <div class="flex justify-center py-3 lg:justify-start">
                            ...
                            <a href="tel:+62 87884433420"  class="pl-3 -pt-2">{{  __('contact.telpon')}} ({{  __('contact.pemilik_telpon')}})</a>
                        </div>
                    </div>
                </div>
                <form wire:submit="sendEmail" class="px-4 py-12 bg-white rounded-3xl dark:bg-black lg:w-2/3 lg:px-8">
                    <div class="grid gap-10 sm:grid-cols-2">
                        <div class="relative">
                            <input wire:model="name" type="text" name="name"
                                class="w-full p-4 font-bold transition bg-transparent border-2 outline-none rounded-2xl border-gray/20 focus:border-secondary ltr:pr-12 rtl:pl-12" />
                            <label for=""
                                class="absolute px-2 font-bold bg-white -top-3 ltr:left-6 rtl:right-6 dark:bg-black dark:text-white">
                                {{  __('contact.name') }}

                                </label>
                            <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                class="absolute -translate-y-1/2 top-1/2 ltr:right-4 rtl:left-4 dark:text-white">
                                <path
                            ...
                            <div>
                                <blade
                                    error|(%26%2339%3Bname%26%2339%3B)%20%3Cspan%20class%3D%26%2334%3Berror%26%2334%3B%3E%7B%7B%2524message%7D%7D%3C%2Fspan%3E%20%40enderror>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <svg width="22" height="21" viewBox="0 0 22 21" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="currentColor" stroke-width="1.8" stroke-linecap="round" />
                                <path d="M5 7.00732L9.8 10.6073C10.5111 11.1407 11.4889 11.1407 12.2 10.6073L17 7.00732"
                                    stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                            <div>
                                <blade
                                    error|(%26%2339%3Bemail%26%2339%3B)%20%3Cspan%20class%3D%26%2334%3Berror%26%2334%3B%3E%7B%7B%2524message%7D%7D%3C%2Fspan%3E%20%40enderror>
                            </div>
                        </div>
                        <div class="relative">
                            <input type="text" name="handphone" wire:model="handphone"
                                class="w-full p-4 font-bold transition bg-transparent border-2 outline-none rounded-2xl border-gray/20 focus:border-secondary ltr:pr-12 rtl:pl-12" />
                            <label for=""
                                class="absolute px-2 font-bold bg-white -top-3 ltr:left-6 rtl:right-6 dark:bg-black dark:text-white">
                                    {{  __('contact.mobile') }}
                            ...
                            <div>
                                <blade
                                    error|(%26%2339%3Bhandphone%26%2339%3B)%20%3Cspan%20class%3D%26%2334%3Berror%26%2334%3B%3E%7B%7B%2524message%7D%7D%3C%2Fspan%3E%20%40enderror>
                            </div>
                        </div>
                        <div class="relative">
                        ...
                        <div>
                            <blade
                                error|(%26%2339%3Bcity%26%2339%3B)%20%3Cspan%20class%3D%26%2334%3Berror%26%2334%3B%3E%7B%7B%2524message%7D%7D%3C%2Fspan%3E%20%40enderror>
                        </div>
                    </div>
                    <div class="relative mt-10">
                        ...
                        <div>
                            <blade
                                error|(%26%2339%3Bmessage%26%2339%3B)%20%3Cspan%20class%3D%26%2334%3Berror%26%2334%3B%3E%7B%7B%2524message%7D%7D%3C%2Fspan%3E%20%40enderror>
                        </div>
                    </div>
                    <div class="mt-10 text-center ltr:lg:text-right rtl:lg:text-left">
                        <button type="submit"
                            class="px-12 text-white capitalize bg-black btn dark:bg-white dark:text-black hover:bg-black">
                            Submit
                        </button>
                    </div>
                </form>
